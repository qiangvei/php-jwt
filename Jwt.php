...
class Jwt
{
    ...
    public function __construct()
    {
        ...
        $this->iss = 'php-jwt';//该JWT的签发者
        $this->iat = time();//签发时间
        $this->exp =  7200;//过期时间
        $this->nbf =  0;//该时间之前不接收处理该Token
    ...
    public function getToken()
    {
        ...
        $payload = [
            ...
            'iat' => $time,//$this->iat,  //签发时间
            'exp' => $time + $this->exp,  //过期时间
            'nbf' => $time + $this->nbf,  //该时间之前不接收处理该Token
            'sub' => $this->sub,  //面向的用户
